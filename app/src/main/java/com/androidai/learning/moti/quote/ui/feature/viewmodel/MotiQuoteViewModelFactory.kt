...
class MotiQuoteViewModelFactory(private val repository: QuoteRepository, private val apiKey:String) : ViewModelProvider.Factory {

  override fun <T : ViewModel> create(modelClass: Class<T>): T {
    if (modelClass.isAssignableFrom(MotiQuoteViewModel::class.java)) {
      @Suppress("unchecked_cast")
      return MotiQuoteViewModel(apiKey, repository) as T
    }
